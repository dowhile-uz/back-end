...
func (s *Service) FetchTokens(ctx context.Context, code, back string) (*usermodelfx.GithubAuthTokensResponse, error) {
	...
	if responseBody.Error != "" {
		return nil, fmt.Errorf("fetch tokens: %s, %s", responseBody.Error, responseBody.ErrorDescription)
	}
